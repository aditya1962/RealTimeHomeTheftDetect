...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.layout.signup);

        Firebase.setAndroidContext(this);
        setContentView(com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.layout.signup);

        Button register = (Button) findViewById(com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.id.signup);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                EditText username = (EditText) findViewById(com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.id.enterUsername);
                EditText password = (EditText) findViewById(com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.id.enterPassword);
                EditText fullname = (EditText) findViewById(com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.id.enterFullName);
                EditText age = (EditText) findViewById(com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.id.enterAge);
                EditText address = (EditText) findViewById(com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.id.enterAddress);
                EditText email = (EditText) findViewById(com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.id.enterEmail);
