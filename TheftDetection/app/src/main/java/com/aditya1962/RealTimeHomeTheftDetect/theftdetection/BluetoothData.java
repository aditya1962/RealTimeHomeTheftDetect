...
public class BluetoothData extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.layout.activity_main);


    btnOn = (Button)findViewById(com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.id.btnOn);
    btnOff = (Button)findViewById(com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.id.btnOff);
