...
public class Bluetooth extends Activity implements OnItemClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.layout.activity_bluetooth);
		init();
		if (btAdapter==null){
	...
	private void init(){
		listView = (ListView)findViewById(com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.id.listView);
	...
	private class ConnectThread extends Thread {
		...
		public BluetoothSocket returnSocket(BluetoothSocket socket)
		{
			BluetoothSocket sc = socket;
			return sc;
		}
	}
	...
	static class ConnectedThread extends Thread {
		...
		public void write(String str) {
			...
			try {
				...
				Log.i("outStream"+Integer.toString(i),Character.toString((char)(Integer.parseInt(Byte.toString(str.getBytes()[i])))));
				try {
					Thread.sleep(20);
				} catch (InterruptedException e) {
					// TODO Auto-generated catch block
