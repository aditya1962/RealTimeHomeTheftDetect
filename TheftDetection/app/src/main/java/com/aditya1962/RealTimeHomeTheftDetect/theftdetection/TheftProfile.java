...
public class TheftProfile extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.layout.theftprofile);
        ...
        TextView txtName = (TextView) findViewById(com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.id.txtName);
        TextView txtEmail = (TextView) findViewById (com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.id.txtEmail);
        TextView txtAddress = (TextView) findViewById(com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.id.txtAddress);

        Button resolve = (Button) findViewById (com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.id.resolve);
