...
public class UserSettings extends Activity {
    ...
    Integer[] imageId = {
            com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.drawable.user,
            com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.drawable.house
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.aditya1962.RealTimeHomeTheftDetect.theftdetection.R.layout.usersettings);
