...
public class UpdateProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText etOne = (EditText)findViewById(R.id.fullname);
        final  EditText etTwo = (EditText)findViewById(R.id.age);
        final  EditText etThree = (EditText)findViewById(R.id.address);
        final  EditText etFour = (EditText)findViewById(R.id.email);
